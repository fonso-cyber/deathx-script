...
local Window = Library:CreateWindow("Death X | By fonso and ace", Vector2.new(300, 300), Enum.KeyCode.RightShift)
...
-- UI Settings
local MenuGroup = Uitab:CreateSector("Menu", "left")

-- Menu keybind and unload button
...
-- Configure save manager settings
SaveManager:IgnoreThemeSettings()
SaveManager:SetIgnoreIndexes({ 'MenuKeybind' })

-- Set up folders for configurations
ThemeManager:SetFolder('DeathXConfig')
SaveManager:SetFolder('DeathXConfig/game-settings')

-- Build the settings interface
SaveManager:BuildConfigSection(Uitab)
ThemeManager:ApplyToTab(Uitab)

-- Load any auto-saved configurations
SaveManager:LoadAutoloadConfig()

-- Create other sections if needed
local testSection = Uitab:CreateSector("Additional Settings", "right")

-- Add your custom UI settings here
testSection:AddToggle(
    "Save Settings",
    false,
    function(value)
...
testSection:AddButton(
    "Reset Settings",
    function()
        -- Your reset settings logic here
    end
)
